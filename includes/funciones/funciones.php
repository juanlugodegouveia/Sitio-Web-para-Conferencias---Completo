...
function productos_json(&$boletos, &$camisas = 0, &$etiquetas = 0) { //Funcion para agrupar boletos, camisas y etiquetas en un JSON. Pasar por referencia "&variable" para mantener los datos.
$dias = array(0 => 'un_dia', 1 => 'pase_completo', 2 => 'pase_2dias'); //Para pasar lo valores de dias a boletos y asi boletos no salga en 0, 1, 2 sino salgan con los nombres de la variable $dias

unset($boletos['un_dia']['precio']); //Unset elimina un dato en posicion de arreglo
