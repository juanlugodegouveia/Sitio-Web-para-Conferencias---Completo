            ...
            <form class="editar-registrado" role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-registrado.php">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input value="<?php echo $registrado['apellido_registrado']; ?>" type="text" class="form-control" id="apellido" name="apellido" placeholder="Nombre">
                </div>
                    ...
                    <div class="caja clearfix row"> <!-- Apertura caja -->
                      ...
                      <div class="total col-md-6"> <!-- Apertura Total, contenedor-->
                        ...
                        <div id="lista-productos"> <!-- Apertura lista-productos-->
                         ...
                         <p>Monto Pagado: <?php echo (float) $registrado['total_pagado']; ?></p>
                        <p>Total:</p>
