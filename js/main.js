...
if(mapa) {
  ...
  L.marker([-33.437057, -70.647860]).addTo(map) //Cambiamos coordenadas en L.marker([-33.437057, -70.647860]).addTo(map), en este caso -33.437057, -70.647860 = monjitas 744
      .bindPopup('GDLWebcamp 2018 <br> Boletos ya disponibles') //Frase encima del puntero del mapa
      .openPopup()
...
$(function() { //Funcion para reconcer en donde hemos dado click en el menu (talleres, conferencias, seminarios)
  ...
  $('.ocultar').hide();//Todas las que esten con ocultar las escondemos para que no se sigan mostrando al pasar de pestañana
    ...
    //Lettering, efecto para las letras en el titulo, utilizando plugins, Lettering, en el HTML se escribio codigo.
    ...
    $('.cuenta-regresiva').countdown('2019/04/05 09:00:00', function (event) {
    ...
    //Animación para descripcion de los invitados y el boton de newsletter - Plugin colorbox, principalmente estaba solo $('.invitado-info').colorbox({inline:true, width:"50%"}); pero lo modifique por que daba error de variable no definida.
